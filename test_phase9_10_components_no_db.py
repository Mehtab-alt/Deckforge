...
# Define the IncidentStatus enum here to avoid database dependency
...
def test_compute_resource_schema():
    ...
    print("[SUCCESS] ComputeResource schema test passed")
...
def test_provider_factory_with_compute_resource():
    ...
    print(f"[SUCCESS] AWS mappings: Small={aws_small}, Large={aws_large}")
...
def test_incident_status_enum():
    ...
    print(f"[SUCCESS] All incident statuses: {all_statuses}")
...
def test_sre_investigator_commands():
    ...
    print(f"[SUCCESS] Safe commands: {SAFE_COMMANDS}")
...
def test_incident_context():
    ...
    print("[SUCCESS] IncidentContext schema test passed")
...
def test_agent_state_with_incident():
    ...
    print("[SUCCESS] AgentState with incident context test passed")
...
def run_all_tests():
    ...
    print("\n[SUCCESS] All Phase 9-10 component tests passed!")
